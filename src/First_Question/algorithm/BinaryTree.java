...
public class BinaryTree {
    ...
    public void drawTree(Node root, String filePath) throws IOException {
        if (root == null) {
            return;
        }
    ...
    private int calculateTotalWidth(Node node) {
        if (node == null) {
            return 0;
        }
        if (node.getName()=='|') {
    ...
    private int calculateTotalHeight(Node node) {
        if (node == null) {
            return 0;
        }
        if (node.getName()=='-') {
    ...
    private void drawNode(Node node, char[][] canvas, int x, int y, int totalWidth, int totalHeight) {
        if (node == null) {
            return;
        }
        if (node.getName()=='|') {
    ...
    private void drawRectangle(char[][] canvas, int x, int y, int width, int height, char name  ) {
